...
/* Palette */
export const c = {
  ink: '#0C1A2E', asphalt: '#10233C', paper: '#F4F4F2', surface: '#FFFFFF',
  amber: '#E39A00', amberDark: '#B87D00', amberSoft: '#FBEFCC', hazard: '#F5B301',
  red: '#D23A2C', redSoft: '#FBE4E1', green: '#1E8E5A', greenSoft: '#E0F0E8',
  blue: '#2C5FB3', blueSoft: '#E4ECFA', line: '#E6E4DF', muted: '#6C7178',
};
